...
# Third-party imports...
from nose.tools import assert_is_none, assert_list_equal, assert_true, assert_is_not_none, assert_true
...
def test_getting_todos3(mock_get):
